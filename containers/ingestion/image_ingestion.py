...
For testing purposes assume the image is from a fictitious car brand "Make_1" and a ficticious model "Model_1" in the city of Auckland, New Zealand.'
...
you need to estimate the repair cost to populate within the output and you need to provide the damage_severity according to the <criteria>, \
you also need to provide a damage_description which is short and less than 10 words. Just provide the json output in the response, do not explain the reasoning. \
For testing purposes assume the image is from a fictitious car brand "Make_2" and a ficticious model "Model_2" in the city of Auckland, New Zealand.'
...
you need to estimate the repair cost to populate within the output and you need to provide the damage_severity according to the <criteria>, \
you also need to provide a damage_description which is short and less than 10 words. Just provide the json output in the response, do not explain the reasoning. \
For testing purposes assume the image is from a fictitious car brand "Make_3" and a ficticious model "Model_3" in the city of Auckland, New Zealand.'
